...
#
execute as @e[type=minecraft:armor_stand,nbt={Invulnerable:1b},limit=10,scores={dwcount=1},sort=random] run execute at @r run summon minecraft:armor_stand ~ 1000 ~ {Invulnerable:1b,Silent:1b,PersistenceRequired:1b,Invisible:1b}
execute as @e[type=minecraft:armor_stand,nbt={Invulnerable:1b},limit=10,scores={dwcount=1},sort=random] run execute at @r run summon minecraft:armor_stand ~ 1000 ~ {Invulnerable:1b,Silent:1b,PersistenceRequired:1b,Invisible:1b}
#
