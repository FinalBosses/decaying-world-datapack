...
#
execute as @e[type=minecraft:armor_stand,nbt={Invulnerable:1b},scores={dwcount=1}] at @s run spreadplayers ~ ~ 0 70 false @s
#
execute as @e[type=minecraft:armor_stand,nbt={Invulnerable:1b},scores={dwcount=1}] at @s run tp @s ~ 254 ~
#
execute as @e[type=minecraft:armor_stand,nbt={Invulnerable:1b},limit=18,scores={dwcount=1},sort=random] run execute at @r run summon minecraft:armor_stand ~ 1000 ~ {Invulnerable:1b,Silent:1b,PersistenceRequired:1b,Invisible:1b}
execute as @e[type=minecraft:armor_stand,nbt={Invulnerable:1b},limit=18,scores={dwcount=1},sort=random] run execute at @r run summon minecraft:armor_stand ~ 1000 ~ {Invulnerable:1b,Silent:1b,PersistenceRequired:1b,Invisible:1b}
#
