...
# setup agents
execute as @e[tag=decay_agent,scores={decay_probe_depth=1..5}] run function dw:setup_agents
...
execute as @e[tag=decay_agent,scores={decay_probe_depth=1..5}] run function dw:park_agents
