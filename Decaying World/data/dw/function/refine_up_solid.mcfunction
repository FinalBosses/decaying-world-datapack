# check 16 blocks above execution location
...
# if no above found, try the next region below
execute unless score @s decay_hit matches 1 positioned ~ ~16 ~ run function dw:probe_up_solid
