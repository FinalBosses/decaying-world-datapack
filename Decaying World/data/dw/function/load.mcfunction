...
scoreboard objectives add decay_probe_depth dummy
scoreboard objectives add decay_probe_mode dummy
scoreboard objectives add decay_probe_dir dummy
scoreboard objectives add decay_dim dummy

# forceload sanctuaries for agents
